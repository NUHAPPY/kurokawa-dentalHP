...
const browserSyncFunc = () => {
  ...
  //  exports.default = series(series(cssSass, jsBabel, imgImagemin, phpFunc), parallel(watchFiles, browserSyncFunc));
   exports.default = parallel(php, series(cssSass, jsBabel, imgImagemin, phpFunc), parallel(watchFiles));
   exports.build = series(cssSass, jsBabel, imgImagemin, phpFunc);